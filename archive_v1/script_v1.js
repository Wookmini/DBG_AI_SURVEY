...
const results = [
    {
        ...
        desc: "AI 기술의 가능성을 이제 막 인지하기 시작하셨군요! 아직은 기존의 방식이 익숙하시겠지만, AI는 생각보다 우리의 수고를 크게 덜어줄 수 있습니다.",
        tips: [
    ...
    },
    {
        ...
        desc: "AI를 생산성 향상 도구로 적절히 활용하고 계십니다! 검색이나 단순 요약 기능을 넘어서 조금 더 고도화된 작업을 AI와 함께 해볼 차례입니다.",
        tips: [
    ...
    },
    {
        ...
        desc: "훌륭합니다! AI에 대해 잘 이해하고 전문적인 영역(분석, 최적화, 기획)에 AI를 능숙하게 결합하고 계시네요.",
        tips: [
    ...
    },
    {
        ...
        level: 4,
        title: "AI 개척자 (Expert)",
        desc: "상위 1%의 AI 활용 능력을 갖추셨습니다! 스스로 AI 혁신을 이끌 뿐만 아니라 사내 AI 문화를 선도할 수 있는 전문가입니다.",
        tips: [
            "DB 글로벌칩 내의 AI 활용 베스트 프랙티스를 발굴하고 사내 교육/세미나 등을 주도해 보세요.",
            "팀 단위의 업무 프로세스 자체를 AI 친화적으로 리모델링할 수 있는 방안을 기획해 보세요.",
            "더 나아가 AI 도입으로 발생할 수 있는 보안 및 윤리적 리스크를 선제적으로 관리해 주세요."
        ]
    }
];
